...
namespace Utilities.Processing
{
    public static class Processing
    {
        ...
        /// <returns>True/ False if it's available or not</returns>
        public static bool CheckProcess(string processName, out Process proc)
        {
            var bResult = false;
            proc = null;
        ...
        /// <returns>True/ False if it's available or not</returns>
        public static bool CheckProcess(string processName, int index, out Process proc)
        {
            var bResult = false;
            proc = null;
        ...
        /// <returns>True/ False if it's available or not</returns>
        public static bool CheckProcess(string processName, out List<Process> processes)
        {
            var bResult = false;
            processes = null;
