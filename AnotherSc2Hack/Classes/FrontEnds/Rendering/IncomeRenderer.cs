    ...
    public class IncomeRenderer : BaseRenderer
    {
        ...
        protected override void Draw(BufferedGraphics g)
        {
            try
            {
                ...
                var fInternalFont = new Font(PSettings.PreferenceAll.OverlayIncome.FontName, fNewFontSize,
                    FontStyle.Bold);
                ...
                for (var i = 0; i < GInformation.Player.Count; i++)
                {
                    ...
                    var strName = (GInformation.Player[i].ClanTag.StartsWith("\0") ||
                                   PSettings.PreferenceAll.OverlayIncome.RemoveClanTag)
        ...
        private void IncomeRenderer_IsHiddenChanged(object sender, EventArgs e)
        {
